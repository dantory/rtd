...
import { bossNote, distToCore, drawShop, drawStats, wireExact, gameOver, hasPow, hurt, mobPos, MOBNAME, MOBWEAK, namedBoss, paint, POWNAME, spawnMob, startWave, step, tick, waveLanes, wavePool, waveTheme } from "./combat.js";
...
Object.assign(window, { wavePool, waveTheme, MOBNAME, MOBWEAK, bossNote, namedBoss, hasPow, POWNAME, spawnMob, hurt, paint });

import { buildable, COLS, CORE, fragNeed, GNAME, GRADE, hpOf, KIND_IDS, kindCost, kindLv, KINDS, MEDAL_GATE, medalDmg, medalGain, medalRelic, medals, medalsAt, medalSlots, META, metaDmg, newlySeen, nextMedalAt, noteSeen, prestige, refreshSlots, relicsFor, RING, ROWS, S, saveMeta, SLOT_SPOTS, slotMax, upCost, UPGRADES, waveHp, waveN, RARE, rarityOf, skipTo, profOf, PATHS, pathOf, pathReady } from "./core.js";
...
import { bossNote, bossTip, distToCore, drawShop, drawStats, wireExact, gameOver, hasPow, hurt, mobPos, MOBNAME, MOBWEAK, namedBoss, namedSoon, paint, POWCOUNTER, POWNAME, spawnMob, startWave, step, tick, waveLanes, wavePool, waveTheme } from "./combat.js";
...
Object.assign(window, { RARE, rarityOf, skipTo, profOf, PATHS, pathOf, pathReady, wavePool, waveTheme, MOBNAME, MOBWEAK, bossNote, bossTip, namedBoss, namedSoon, hasPow, POWNAME, POWCOUNTER, spawnMob, hurt, paint });

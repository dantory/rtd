...
/* ══════════════════════════════════════════════════════════════
   전투력 — **성장이 장부에만 있으면 성장이 아니다.**
   ──────────────────────────────────────────────────────────────
   판당 예닐곱 번 무언가를 사는데 산 것이 「공격력 +13%」라 화면에는 아무 일도 안 일어난다.
   실제로 재 보니 눈에 보이는 변화는 「자리 +1」 하나뿐이었다 — 곱해지는 축이 넷인데
   불어나는 게 안 보이니 "성장의 재미가 있냐"는 물음이 나온다.
   그래서 **하나의 숫자**로 모은다. 지금 벙커가 초당 뿜는 피해다: 업그레이드도, 훈련도,
